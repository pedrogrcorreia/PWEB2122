...
namespace Ex1{
    class Program{
        static void Main(string[] args){
            ...
            u.AddTask("Exam", Priority.Medium, limitDate: "30/10/2021 09:30");
            u.AddTask("Another exame", Priority.Medium);
            u.AddTask(limitDate: "30/10/2021 10:30");
            u.AddTask(limitDate: "30/10/2021 14:30");
            ...
            u.ShowTasks(u.Tasks, "\nAll Tasks\n");
            u.ShowTasks(u.OrderTasksBy(OrderType.priority, true), "\n Orderer by priority\n");
            u.ShowTasks(u.OrderTasksByLimitDate(), "\nOrdered tasks by limit date\n");
        }
    }
}
